...
def gen_train_list(data_dir):
    root_data_path = os.path.join(data_dir, 'Food-101N_release/meta/imagelist.tsv')
    class_list_path = os.path.join(data_dir, 'Food-101N_release/meta/classes.txt')

    file_path_prefix = os.path.join(data_dir, 'Food-101N_release/images')
    ...
    save_dir = check_folder(data_dir)
...
def gen_test_list(arg_map_name2cat, data_dir):
    map_name2cat = arg_map_name2cat
    root_data_path = os.path.join(data_dir, 'food-101/meta/test.txt')

    file_path_prefix = os.path.join(data_dir, 'food-101/images')
...
if __name__ == '__main__':
    map_name2cat = gen_train_list('/home/jian/Label_noise_dataset')
    gen_test_list(map_name2cat, '/home/jian/Label_noise_dataset')
